...
df = pd.read_json('https://apisidra.ibge.gov.br/values/t/6406/n6/2927408/v/8186,8188,8190,8192/p/all/c86/allxt?formato=json')
#df.info()
...
print(graf)
graf.to_csv('E:/Área de trabalho/Códigos/R/rs_dados_trabalhoemprego_cargahoraria/data/recossa_cargahoraria_rc.csv', index=False)
